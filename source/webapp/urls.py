...
from webapp.views.product_views import ProjectsView, ProjectDetailView, ProjectCreateView, ProjectUpdateView, \
    ProjectDeleteView
from webapp.views.review_views import TaskCreateView, \
     ReviewView, TaskUpdateView, TaskDeleteView
...
urlpatterns = [
    ...
    path('task/<int:pk>', ReviewView.as_view(), name='tasks_view'),
